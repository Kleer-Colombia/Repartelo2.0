...
describe CalculateTaxes do
  ...
  it 'should calculate chanchito' do
    ...
    cib = CalculateTaxes.new(taxes: Tax.all, incomes: 1000000)
    cib.call
  ...
  it 'should calculate chanchito and Ica' do
    ...
    cib = CalculateTaxes.new(taxes: Tax.all, incomes: 3000000)
    cib.call
  ...
  it 'should calculate Ica, chanchito with expensives' do
    ...
    cib = CalculateTaxes.new(taxes: Tax.all, incomes: 1234567, expenses: 8912)
    cib.call
  ...
  it 'should calculate Ica, chanchito and retefuente with expensives' do
    ...
    cib = CalculateTaxes.new(taxes: Tax.all, incomes: 100000, expenses: 1000)
    cib.call
  ...
  it 'should calculate Ica, chanchito, retefuente and KleerCo' do
    ...
    cib = CalculateTaxes.new(taxes: Tax.all, incomes: 100000)
    cib.call
