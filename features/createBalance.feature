Feature:
  As Yamit
  I want to create a new balance
  In order to replace google sheets

  @javascript
  Scenario: create new balance
    Given I logged
    When I create a new balance for client "Sparkta"
    Then I should the principal page for the balance

  @javascript
  Scenario: create new balance
    Given I logged
    When I create a new balance for client ""
    Then I should the an error message

  @javascript
  Scenario: create new balance with one income
    Given I logged
  ...
  @javascript
  Scenario: create new balance with many incomes
    Given I logged
    And I create a new balance for client "Corb"
  ...
  @javascript
  Scenario: create new balance with one expense
    Given I logged
    And I create a new balance for client "Sparkta"
